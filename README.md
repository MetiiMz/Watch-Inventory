...
> **نسخه‌ی فعلی روی Django 5.2 بازنویسی شده است.** رابط کاربری و رفتار برنامه دقیقاً مثل نسخه‌ی Flask قبلی است؛ فقط موتور پشت آن سریع‌تر و استانداردتر شده. کد قدیمی Flask به‌طور کامل حذف شده است — هیچ وابستگی به آن وجود ندارد.
